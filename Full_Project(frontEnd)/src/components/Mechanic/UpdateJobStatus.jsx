...
import bgImage from "/src/images/UpdateJob.jpg";
...
function UpdateJobStatus() {
  ...
  return (
    ...
    >
      ...
      {/* Form Container */}
      <div className="bg-white-10 rounded-2xl shadow-2xl p-8 w-full max-w-lg border border-indigo-100 hover:shadow-indigo-200 transition-all">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="flex items-center border border-gray-300 rounded-lg px-4 py-2 focus-within:ring-2 focus-within:ring-indigo-400">
              <Wrench className="text-indigo-600 mr-2" />
              <select
                value={selectedJobId}
