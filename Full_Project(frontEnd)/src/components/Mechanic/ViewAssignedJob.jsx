...
import bgImage from "/src/images/AssignedJob.jpg";
    ...
    >
      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {jobs.map((job) => (
          <div
            key={job.id}
            className="bg-white-10 backdrop-blur-md rounded-2xl shadow-lg p-6 hover:scale-105 transition-all border border-indigo-100"
          >
      ...
      {/* Footer */}
      <div className="text-center mt-12 text-sm text-blue-600 relative top-[220px]" >
