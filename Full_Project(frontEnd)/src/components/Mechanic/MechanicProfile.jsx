...
import bgImage from "/src/images/MechanicProfile.jpg";
  ...
  return (
    ...
    >
      ...
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold text-indigo-700 mb-2 flex items-center justify-center gap-2 relative top-[-50px]">
          <User className="w-8 h-8 text-indigo-600" />
          Mechanic Profile
        </h1>
        <p className="text-indigo-600 text-lg relative top-[-50px]">
          View and manage your personal details
        </p>
      </div>

      {/* Profile Card */}
      <div className="bg-white-10 backdrop-blur-md shadow-2xl rounded-2xl p-8 max-w-3xl w-full border border-indigo-100 hover:shadow-indigo-200 transition-all">
        {/* Top Section */}
