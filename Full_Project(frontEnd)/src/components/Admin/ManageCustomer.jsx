...
import bgImage from "/src/images/ManageCust.jpg";
...
function ManageCustomer() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto bg-white-10 rounded-2xl shadow-xl p-8">
        {/* Header */}
          ...
          <table className="min-w-full border border-indigo-200 rounded-lg overflow-hidden">
            ...
            <tbody>
              {filteredCustomers.map((customer, index) => (
                <tr
                  key={customer.id}
                  className="hover:bg-indigo-50 transition-all border-b text-yellow-100"
                >
      ...
      {/* Footer */}
      <footer className="mt-12 text-sm text-white text-center">
