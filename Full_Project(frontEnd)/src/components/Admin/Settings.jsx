...
import bgImage from "/src/images/ManageJob.jpg";
...
function Settings() {
  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto bg-white/10 backdrop-blur-md rounded-2xl shadow-xl p-8">
        <h1 className="text-3xl font-bold text-green-700 mb-8 text-center flex items-center justify-center gap-3">
        ...
        <div className="space-y-6">
          <div className="border border-indigo-100 rounded-xl p-6 shadow-sm hover:shadow-md transition">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-xl font-semibold text-blue-500">Details</h2>
            </div>
