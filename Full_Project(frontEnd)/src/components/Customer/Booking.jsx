...
import bgImage from "/src/images/BookService.jpg";
  ...
  return (
    ...
    >
      ...
      <main className="flex-grow flex items-center justify-center px-6 py-10">
        <div className="bg-white-10 backdrop-blur-md shadow-xl rounded-2xl p-8 w-full max-w-lg ml-233">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g., CafeRacer,CityRider,Himalyan... "
            ...
            <div>
              ...
              >
                ...
                <option value="tireRotation">Tire Allignment</option>
                ...
                <option value="Mileage Check">Mileage Check</option>
